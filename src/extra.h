...
public:
    ...
    static std::chrono::time_point<std::chrono::steady_clock> lastMoveTime;// = std::chrono::steady_clock::now();
    static const int IDLE_THRESHOLD_MS;// = 100; // tempo de inatividade do mouse para considerar que ele parou
